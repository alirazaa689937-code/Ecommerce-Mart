    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          >
            <h3 className="font-semibold mb-4 text-purple-500 text-xl">
              About GharMart
            </h3>
            ...
            <div className="flex space-x-4">
              {/* Social Icons (external links can keep <a> tags) */}
              <motion.a
              ...
              {/* Other social icons remain with <a> tags since they're external */}
            </div>
          </motion.div>

          {/* Quick Links - Now using React Router Links */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {/* Customer Service - Keep external links as <a> tags */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          >
            &copy; {currentYear} GharMart. All rights reserved.
          </motion.p>
